...
plt.xlabel('Actual months_on_chart')
plt.ylabel('Predicted months_on_chart')
plt.title('Simple Linear Regression: Actual vs Predicted months_on_chart')
plt.tight_layout()
plt.savefig('simple_linear_regression_months_on_chart.png') 
plt.show()